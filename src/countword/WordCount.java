...
public class WordCount {
  ...
  static class changeKey extends DoFn<KV<String, Long>, KV<String, Long>> {
	    ...
	    public void processElement(ProcessContext c) {
			...
			KV<String,Long> newV=KV.of(key.toUpperCase(), value);
  ...
  public static class FormatAsTextFn extends SimpleFunction<KV<String, Long>, String> {
    ...
    public String apply(KV<String,Long> input) {
    	 /*Iterable<Long> valuelist = input.getValue();
    	 StringBuffer sb=new StringBuffer(input.getKey());
    ...
    public static class FormatAsTextFn2 extends SimpleFunction<KV<String, Iterable<Long>>, String> {
    @Override
    public String apply(KV<String, Iterable<Long>> input) {
    	 Iterable<Long> valuelist = input.getValue();
    	 StringBuffer sb=new StringBuffer(input.getKey());
    	 for (Long i : valuelist){
    		 sb.append(","+i.toString());
  ...
  public static class CountWords extends PTransform<PCollection<String>,
    ...
    public PCollection<KV<String, Long>> expand(PCollection<String> lines) {
	  ...
	  PCollection<KV<String, Long>> nWordCounts =
          wordCounts.apply( ParDo.of(new changeKey()));
  ...
  public static void main(String[] args) {
    ...
    p.apply("ReadLines", TextIO.read().from(options.getInputFile()))
	 ...
	 //.apply(Combine.perKey<String, Long, Long>(new Sum.SumLongFn()))
	// .apply(Combine.<String, Long, Long>perKey(new Sum.SumLongFn()))
     .apply(Sum.<String>longsPerKey())
     //.apply(MapElements.via(new FormatAsTextFn2()))
